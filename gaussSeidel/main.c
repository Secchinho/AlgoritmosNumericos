...
int main()
{
    ...
    //lendo o tamanho da matriz e a precis�o
    ...
    //repetir at� que o erro esteja aceit�vel
    while(erro>precisao){
    ...
    //encontrando o maior valor em m�dulo
    ...
    //finaliza��o da contagem de tempo
    fim = clock();
