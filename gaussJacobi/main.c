...
int main()
{
    ...
    //n�o perco a posi��o de onde parou a leitura
    //lendo tamanho da matriz e precis�o
    ...
    //in�cio da conta - in�cio da contagem de tempo
    inicio = clock();
    ...
    //conta ser� realizada at� que o erro esteja aceit�vel (menor que a precis�o)
    while(erro > precisao){
    float valor;
    ...
    for(i=0;i<tamanho-1;i++){ //fabs() considera o m�dulo do n�mero
    ...
    //reconfigurando o vetor para continuar o loop (se necess�rio)
    for(i=0;i<tamanho;i++){
        vet0[i] = vet1[i];
    }
